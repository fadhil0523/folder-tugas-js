...
let permenAna = 30;
let permenBudi = 10;
let updateOnePermenAna = permenAna - permenBudi;
let updateTwoPermenAna = updateOnePermenAna * 2;

console.log(updateTwoPermenAna);
console.log(20 * 2);
...
console.log(kucingOne);
console.log(kucingTwo);
console.log("nama kucing ana " + kucingOne + " " + kucingTwo);
...
// console log pertama itu string tambah string bukan number tambah number makanya hasilnya 1211 bukan 23

let hasilNyamukAngsa = +nyamuk + angsa;
console.log(hasilNyamukAngsa);
//console log kedua karena tipe data yang kedua number dan tipe kedua string kemudian di jumlahkan maka tipe data string di convert jadi number maka hasilnya jadi 21
